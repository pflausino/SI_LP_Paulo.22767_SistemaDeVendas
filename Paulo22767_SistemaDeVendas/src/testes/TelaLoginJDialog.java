 ...
 * @author Pflausino
 */
public class TelaLoginJDialog extends javax.swing.JFrame {

    /**
     * Creates new form TelaLoginJDialog
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLoginJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLoginJDialog().setVisible(true);
            }
        });
    }
